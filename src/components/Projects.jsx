...
import { ProjectsContainer, ProjectDiv, ProjectTextWrapper, ProjectFontAwesomeIcon, Project2FontAwesomeIcon } from '../styles/ProjectsStyle'
...
const Projects = () => {
    ...
    return (
        <ProjectsContainer>
            <ProjectDiv>
                <a href="https://didact-fe.netlify.com/landing" target="_blank"><h2>Didact</h2></a>
                ...
                <ProjectTextWrapper>
                    ...
                    <ul style={{paddingLeft: '20px'}}>
                        ...
                        <a href="https://github.com/Lambda-School-Labs/didact-be" target="_blank"><li>https://github.com/Lambda-School-Labs/didact-be</li></a>
                    </ul>
                    <ProjectFontAwesomeIcon onClick={() => openGithub("https://github.com/Lambda-School-Labs/didact-fe")} icon={faGithubSquare} size='3x' />
                </ProjectTextWrapper>
            </ProjectDiv>
            <ProjectDiv>
                <a href="https://restaurants-nearby.netlify.com/home" target="_blank"><h2>Restaurant Passport</h2></a>
                ...
                <ProjectTextWrapper>
                    ...
                    <ul style={{paddingLeft: '20px'}}>
                        <li>Restaurant Passport was built to the specifications of the U/X designer</li>
            ...
            <ProjectDiv>
                ...
                <a href="https://bookrlambda.netlify.com/" target="_blank"><h2>Bookr</h2></a>
                ...
                <ProjectTextWrapper>
                    ...
                    <ul style={{paddingLeft: '20px'}}>
                        <li>Bookr was built to the specifications of the U/X designer.</li>
            ...
            <ProjectDiv>
            <a href="https://jondscott21-internationschool.herokuapp.com/swagger-ui.html" target="_blank"><h2>International School</h2></a>
